...
from .boundingboxes import BoundingBox, Training
...
class FoundMonosaccharide(BoundingBox):
    ...
    id_beginnings = tuple(iupac for iupac in backwards_class_dictionary.keys())
            ...
            for contour in contours_list:
                ...
                if squareness < 2 and arearatio > 100 and arearatio1 > 200:
                    ...
                    if color == "red_mask":
                        ...
                        score = self.compare2img(white, yellow_img)
...
class YOLOMonos(YOLOModel, MonoID):
    ...
    def find_monos(self, image, **kw):
        ...
        mono_boxes = self.get_YOLO_output(image_dict, threshold, class_options=True)
